...
CREATE TABLE slot_master_update(
    ...
    rtp DECIMAL(2,2) NULL,
    hold DECIMAL(2,2) NULL,
    ...
    prog_level INT NULL,
    reset_1 DECIMAL(8,2) NULL,
    reset_2 DECIMAL(8,2) NULL,
    reset_3 DECIMAL(8,2) NULL,
    reset_4 DECIMAL(8,2) NULL,
    reset_5 DECIMAL(8,2) NULL,
    reset_6 DECIMAL(8,2) NULL,
    reset_7 DECIMAL(8,2) NULL,
    reset_8 DECIMAL(8,2) NULL,
    prog_1 DECIMAL(2,2) NULL,
    prog_2 DECIMAL(2,2) NULL,
    prog_3 DECIMAL(2,2) NULL,
    prog_4 DECIMAL(2,2) NULL,
    prog_5 DECIMAL(2,2) NULL,
    prog_6 DECIMAL(2,2) NULL,
    prog_7 DECIMAL(2,2) NULL,
    prog_8 DECIMAL(2,2) NULL,
